...
**Status:** Marketplace listings are ERC-8004 tokenURI rows on BSC testnet (chain 97). Twelve AgentCore sellers are mapped (3 per category; ids `2066`/`2476`/`2489`, `2207`/`2477`/`2490`, `2208`/`2479`/`2492`, `2209`/`2478`/`2491`). ERC-8183: job `963` **SUBMITTED** (grid). Jobs `1115` / `1120` / `1121` **FUNDED** — deliverables blocked by Pieverse `auto/free` 429.
...
**Coverage:** three AgentCore sellers per category (`2066`+`2476`+`2489` / `2207`+`2477`+`2490` / `2208`+`2479`+`2492` / `2209`+`2478`+`2491`). Hireable on the deployed site after the matching Cognito secret is set on Vercel.
...
Twelve AWS AgentCore runtimes (account `850122838544`, region `us-east-1`). Hire rail is ERC-8183 on BSC testnet (`chain_id=97`). Quoted price: `0.10 U` per task.
...
| Grid CAKE / BNB (`grid-cake-bnb`) | `2489` | [`0x6dB4951Cc7c1A5AEBDC83C0545DFCc233FC77c6C`](https://testnet.bscscan.com/address/0x6dB4951Cc7c1A5AEBDC83C0545DFCc233FC77c6C) | `arn:aws:bedrock-agentcore:us-east-1:850122838544:runtime/gridcakebnb-YHsx9AEWsP` |
...
| Rebalancing Thena (`rebalancing-thena`) | `2490` | [`0xec379E4C61626DC68485C60295a3cAADf7c85D25`](https://testnet.bscscan.com/address/0xec379E4C61626DC68485C60295a3cAADf7c85D25) | `arn:aws:bedrock-agentcore:us-east-1:850122838544:runtime/rebalancingthena-7H7FFpCRm2` |
...
| HF Guard Venus USDC (`hf-guard-venus-usdc`) | `2492` | [`0x10B76CA388Ed2F81320617F343dbA24040253E0D`](https://testnet.bscscan.com/address/0x10B76CA388Ed2F81320617F343dbA24040253E0D) | `arn:aws:bedrock-agentcore:us-east-1:850122838544:runtime/hfguardvenususdc-zuny8PELL4` |
...
| Yield Lista USDT (`yield-lista-usdt`) | `2491` | [`0x94dCb2EA7A64Bccf701b70841c5771168a9F910E`](https://testnet.bscscan.com/address/0x94dCb2EA7A64Bccf701b70841c5771168a9F910E) | `arn:aws:bedrock-agentcore:us-east-1:850122838544:runtime/yieldlistausdt-OhWXLkAFWp` |
...
| `grid-cake-bnb` | Grid Trading | PancakeSwap | **Live** — ERC-8004 `2489`, AgentCore `gridcakebnb-YHsx9AEWsP` |
...
| `rebalancing-thena` | Rebalancing | PancakeSwap v3 pool views | **Live** — ERC-8004 `2490`, AgentCore `rebalancingthena-7H7FFpCRm2` |
...
| `hf-guard-venus-usdc` | Health Factor Monitoring | Venus | **Live** — ERC-8004 `2492`, AgentCore `hfguardvenususdc-zuny8PELL4` |
...
| `yield-lista-usdt` | Yield Optimisation | Venus views (Lista listing) | **Live** — ERC-8004 `2491`, AgentCore `yieldlistausdt-OhWXLkAFWp` |
...
- [x] Deploy twelve sellers on AWS AgentCore (three per category): `2066`/`2476`/`2489`, `2207`/`2477`/`2490`, `2208`/`2479`/`2492`, `2209`/`2478`/`2491`.
...
- [x] ≥3 AgentCore sellers per category on chain 97 (hireable once Cognito secrets are on Vercel).
- [ ] Vercel Cognito secrets for the third-of-category sellers + a fresh SUBMITTED hire from the deployed site.
