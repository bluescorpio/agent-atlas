...
export interface AgentIdentity { agentId: string; owner: `0x${string}`; wallet: `0x${string}`; name: string; description: string; endpoint?: string; registeredAt: number; erc8004Id?: number; }
