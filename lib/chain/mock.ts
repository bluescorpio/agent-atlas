...
const names: Record<string, string> = {
  ...
  'hf-guard-venus': 'HF Guard Venus', 'rebalancing-pcs-v3': 'Rebalancing PCS v3',
...
const values: Record<string, number[]> = {
  ...
  'hf-guard-venus': [24, 7, 420, 0], 'rebalancing-pcs-v3': [91.6, 14, 184000, 0],
  'yield-stable-router': [14.8, 6, 1200000, 0],
};
